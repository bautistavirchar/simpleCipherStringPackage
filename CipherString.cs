...
namespace simpleCipherStringPackage
{
    public class CipherString
    {
        ...
        /// Encrypt text
        /// </summary>
        /// <param name="textData">Plain text</param>
        /// <param name="Encryptionkey">Your salt key</param>
        ...
        {  
            ...
            return EncodeUtility.Base64UrlEncode(objtransform.TransformFinalBlock(textDataByte, 0, textDataByte.Length));
        }
        ...
        {  
            ...
            byte[] encryptedTextByte = EncodeUtility.Base64UrlDecode(EncryptedText);
            byte[] passBytes = Encoding.UTF8.GetBytes(Encryptionkey);  
